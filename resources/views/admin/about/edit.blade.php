...
@section('title','Edit About Page | Arthafal')
@section('styles')
...
@section('main-content')
        @if(isset($aboutDetail))
            {{Form::open(['url'=>route('about.update',$aboutDetail->id), 'files'=>true, 'class'=>'form'])}}
            @method('patch')
        @endif
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-head" style="background: #253544; gradient(left, #1c65a9 0%, #5a5c5c 100%) !important; border-radius: 10px;" >
                    ...
                    <a href="http://127.0.0.1:8000/arthafal/about" class="btn btn-secondary pull-right" id="close"><i class="fa fa-times"> </i> close</a>
                </div>
                ...
                <div class="ibox-body">
                    ...
                    <div class="form-group row">
                        ...
                        @if(isset($aboutDetail))
                            <div class="col-md-4">
                                <img src="{{asset('uploads/about/'.$aboutDetail->image)}}" alt="" class="img img-responsive img-thumbnail" width="100px;">
                            </div>
                        @endif
                    </div>
                    <div class="form-group row">
                        {{Form::label('top_description','Top Data Description :',['class'=>'col-md-3'])}}
                        <div class="col-md-9">
                            {{Form::text('top_description',@$aboutDetail->top_description,['class'=>'form-control form-control-md','id'=>'top_description','required'=>false,'placeholder'=>'Enter Top  Description........'])}}
